...
/**
 * Pruefung fuer das Feld Reserve2 aus dem Baustein DBKV.
 */
public class PruefungReserve2 extends AbstractFeldPruefung<FeldNameDBKV, FehlerNummerDBKV> {
	 ...
	 */
	public PruefungReserve2(final Feld<FeldNameDBKV> feld, final Feld<FeldNameDBKV> feldKennzst) {
		super(feld);
	...
	public void initialisiereFeldUebergreifendePruefungen() throws UngueltigeDatenException {
		if (isPruefbar(FehlerNummerDBKV.DBKV112, feldKennzst) && feldKennzst.getTrimmedValue().compareTo("N") == 0) {
			final PruefungLaenge kv102 = new PruefungLaenge(0, getFeld());
			addPruefungFeldUebergreifend(kv102, new Fehler<FehlerNummerDBKV>(FehlerNummerDBKV.DBKV112));
		}
	}
