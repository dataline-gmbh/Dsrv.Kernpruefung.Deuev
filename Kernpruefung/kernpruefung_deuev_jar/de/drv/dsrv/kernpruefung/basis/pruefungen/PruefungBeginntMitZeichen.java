 ...
 */
public class PruefungBeginntMitZeichen extends AbstractPruefung {
	 ...
	 */
	public PruefungBeginntMitZeichen(final List<Character> erlaubteZeichen, final Feld<?> feld) {
		super(feld);
	...
	public boolean pruefe() throws UngueltigeDatenException {
		...
		if (getFeld() != null && getFeld().getTrimmedValue() != null) {
			...
			if (StringUtils.isNotEmpty(feldValue) && erlaubteZeichen != null) {
